...
<html lang="zh-CH">
  ...
  <body>
    <div style="width: 800px ;height: auto; margin-left: 400px;margin-top: auto">
      <h4>恭喜您登录成功，查询的信息如下</h4>
     <%--查询--%>
      <table cellspacing="5px" border="2px" bgcolor="#7fffd4" cellpadding="15px">

        <tr>
          <td>编号</td>
          <td>商品</td>
          <td>单价</td>
          <td colspan="2" ><a href="addList.jsp">添加数据</a></td>
        </tr>
