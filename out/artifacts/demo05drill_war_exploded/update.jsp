    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" id="qq" class="form-control" name="qq" value="${user.qq}" placeholder="请输入qq"/>
          </div>

          <div class="form-group">
            <label for="email">Email：</label>
            <input type="text" id="email" class="form-control" name="email" value="${user.email}" placeholder="邮箱"/>
          </div>
